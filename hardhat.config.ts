...
task("6_nft_zksync", "Deploys NFT contract on zkSync")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const app_id = "0x3655ca59b7d566ae06297c200f98d04da2e8e89812d627bc29297c25db60362d";
    const app_id_2 = "0x1f5ff885ceb5bf1350c4449316b7d703034c1278ab25bcc923d5347645a0117e";
...
task("7_nftpayment_zksync", "Deploys NFT payment contract on zkSync")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const MyNFTPaymentArtifact = await deployer.loadArtifact("NFTPaymentMailbox");
