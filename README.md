...
> Spin up 2 instances of ZK Sync using the following instructions.

```
git clone https://github.com/vibhurajeev/zksync-era
```

Now follow the intructions in:

- https://github.com/vibhurajeev/zksync-era/blob/main/docs/guides/setup-dev.md
- https://github.com/vibhurajeev/zksync-era/blob/main/zk_toolbox/README.md
- Bridging: https://github.com/vibhurajeev/zksync-era/blob/main/docs/guides/advanced/02_deposits.md
...
Update the config:
`general.yaml` in `chains/era/configs` with:
...
prometheus:
  ...
  push_interval_ms: 100
db:
  state_keeper_db_path: /Volumes/Personal/Avail/zksync-era/./chains/era/db/main/state_keeper
  merkle_tree:
    path: /Volumes/Personal/Avail/zksync-era/./chains/era/db/main/tree
    mode: FULL
...
protective_reads_writer:
  db_path: ./chains/era/db/main/protective_reads
  window_size: 3
...
basic_witness_input_producer:
  db_path: ./chains/era/db/main/basic_witness_input_producer
  window_size: 3
  first_processed_batch: 0
...
experimental_vm:
  playground:
    fast_vm_mode: SHADOW
    db_path: ./chains/era/db/main/vm_playground
    first_processed_batch: 0
    reset: false
...
prometheus:
  ...
  push_interval_ms: 100
db:
  state_keeper_db_path: /Volumes/Personal/Avail/zksync-era/./chains/era2/db/main/state_keeper
  merkle_tree:
    path: /Volumes/Personal/Avail/zksync-era/./chains/era2/db/main/tree
    mode: FULL
    multi_get_chunk_size: 500
    block_cache_size_mb: 128
    memtable_capacity_mb: 256
