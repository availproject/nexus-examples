...
async function main() {
    ...
    try {
        ...
        const tx = await bridgeContractZKSYNC1.sendERC20(assetId, ethers.zeroPadValue(ethers.toBeHex(signerZKSYNC1.address), 32), lockAmount, [appId2], nonce, [mailboxAddressZKSYNC2]);
        ...
        const mailboxLogs = receipt.logs.filter((log) => log.address.toLowerCase() === mailboxAddressZKSYNC1.toLowerCase());
