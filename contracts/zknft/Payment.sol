...
abstract contract Payment {
    ...
    uint256 public constant NAMES_MAPPING_SLOT = 0;
    ...
    event NewEntry(uint256 key, bytes32 hash_value);

    event PreImage(bytes1 messageType, bytes32 from, bytes data, uint256 messageId, uint256 chainId);
